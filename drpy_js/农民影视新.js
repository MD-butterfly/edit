var rule={
	...
	limit:6,
	double:true,
	推荐:'.main div.index-area;ul&&li;*;*;*;*',
	一级:'.index-area&&ul&&li;a&&title;img&&data-original;p.other&&Text;a&&href',
	二级:{
		"title":".name--span&&Text;.bz&&Text",
		"img":"img.lazy&&data-original",
		"desc":".ct-c&&dd&&Text;.ct-c&&dt:eq(0)--span&&Text;;.ct-c&&dt:eq(1)--span&&Text;.ct-c&&dt:eq(2)--span&&Text",
		"content":".tab-jq&&Text",
		"tabs":".playfrom li",
		"lists":".videourl&&ul:eq(#id) li"
	},
	搜索:'*',
